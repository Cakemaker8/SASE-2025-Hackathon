...
#extra models
from sklearn.svm import SVC #SVC(kernel='linear) or rbf
...
from sklearn.ensemble import GradientBoostingClassifier #GradientBoostingClassifier(n_estimators=100)
from sklearn.neural_network import MLPClassifier #MLPClassifier(hidden_layer_sizes=(100,), max_iter=1000)
